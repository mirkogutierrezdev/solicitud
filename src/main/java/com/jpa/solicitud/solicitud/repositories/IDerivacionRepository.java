...
public interface IDerivacionRepository extends JpaRepository<Derivacion, Long> {
         ...
         * )
         * void marcarComoNoLeida(@Param("derivacionId") Long
         * idDerivacion, @Param("solicitudId") Long idSolicitud,
         * 
         ...
         * Derivacion findDerivacionByIdAndFuncionario(@Param("idDerivacion") Long
         * idDerivacion,
         * 
