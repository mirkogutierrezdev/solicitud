...
public class SolicitudControllers {
    ...
    @GetMapping("/bydepartamento")
    public ResponseEntity<Object> obtenerSolicitudesPorDepartamentoYFechas(
            @RequestParam Long departamentoId,
            @RequestParam LocalDate fechaInicio,
            @RequestParam LocalDate fechaFin) {

        try {
            List<Solicitud> solicitudes = solicitudService.obtenerSolicitudesPorDepartamentoYFechas(
